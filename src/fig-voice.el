...
Call K when done.
If VOLUME is specified, use it :)."
  (fig//play-audio (s-concat "/home/llll/src/fig/assets/rats/users/" user ".wav") k volume))
...
USER it's your birthday today."
  (fig//play-audio
   "/home/llll/src/fig/assets/rats/rats1.ogg"
   (lambda ()
     (fig//say-chatter-name
      ...
      (lambda ()
        (fig//play-audio
         "/home/llll/src/fig/assets/rats/rats2.ogg"
         (lambda ()
           (fig//say-chatter-name
            user
            120
            (lambda ()
              (fig//play-audio
               "/home/llll/src/fig/assets/rats/rats3.ogg"))))))))))
